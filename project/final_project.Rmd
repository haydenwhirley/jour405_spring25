...
Questions: do you recommend calculating the mean over the years for both streaming & movie theater, and finding the sd that year is from the mean? What about pct change between the years? are there more statistical analysis I could do that determine relationship/correlation?
