...
In this analysis, I am looking at the relationship between 
my hypothesis is that as 
comparing hulu & domestic box office? both national numbers for the united states
both subcriptions & tickets sold, and revenues

look at a leading streaming services

context on how i am doing up to 2019, when streaming took of, covid years would mess up numbers
hypothesis that as streaming became more popular, watching at home movies and tv shows at your fingertips, led to decrease in the succes of movie theathers, whether thats measured in ticket sold or total revenue
...
- Overall mean and standard deviation for each variable, then find the z-score for each year to identify unusually high or low changes
