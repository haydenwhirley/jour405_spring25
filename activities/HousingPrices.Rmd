...
Local officials claim the new city transit line has boosted home values, and new data validates their statement. A statistical analysis shows that average home prices have risen from $285K to $304.5K, a $19.5K increase, since the transit line's introduction.

With a 6.8% increase and a p-value of 0.000018, the data provides strong statistical evidence that this rise is unlikely to be a random coincidence. The findings suggest a strong correlation between the transit expansion and rising home values, though other market factors may also be at play.
