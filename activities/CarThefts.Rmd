...
The general shape of it is normal, but because this data is slightly skewed to the right, it seems there are higher values that pull the average up. Those values are within one standard deviation of the mean.
