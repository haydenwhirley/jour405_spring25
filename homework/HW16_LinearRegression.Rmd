...
In comparison to the scatterplot from the class activity, this one shows a more clearly defined relationship, meaning the negative correlation between FARMS percentage and math test scores is more visually apparent, instead of weak.
